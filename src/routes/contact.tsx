  ...
  head: () => ({
    meta: [
      { title: "Contact & Booking | Chawla Cranes" },
      {
        name: "description",
        content:
          "Book heavy-lift cranes or speak with our 24/7 deployment desk across Gurugram, Manesar and Noida.",
      },
    ],
  }),
      ...
      <main className="pt-32 pb-24 px-6 md:px-12 max-w-screen-2xl mx-auto">
        <header className="mb-16">
          ...
          <p className="max-w-2xl text-secondary text-lg font-medium leading-relaxed">
            Connect with our deployment logistics team. Precision-engineered lifting solutions begin
            with a technical consultation for your NCR project.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <section className="lg:col-span-2 bg-surface-container-low rounded-xl p-8 md:p-12 shadow-sm border border-outline-variant/30">
            ...
            {submitted ? (
              <div role="status" className="py-16 text-center">
                <Icon name="check_circle" className="text-primary text-5xl mb-4" />
                <p className="text-2xl font-bold text-on-surface mb-2">Request received</p>
                <p className="text-secondary">
                  Our deployment logistics team will follow up shortly to confirm your quote.
                </p>
              </div>
            ) : (
              <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    {
                      label: "Project Location (Gurugram/Manesar/Noida)",
                      icon: "location_on",
                    ...
                    },
                    {
                      label: "Company Name",
                      icon: "corporate_fare",
                      placeholder: "Your Infrastructure Firm",
                      type: "text",
                      name: "company_name",
                      required: false,
                    },
                    ...
                    {classes.map((c) => {
                      ...
                      return (
                        ...
                        >
                          <Icon
                            name={c.icon}
                            className={`mb-2 ${isActive ? "text-primary" : "text-outline"}`}
                          />
                ...
                <div className="flex justify-end pt-4">
                  <button
                    type="submit"
                    className="bg-primary text-on-primary px-10 py-4 rounded-lg font-bold text-lg hover:bg-primary/90 transition-all active:scale-95 shadow-xl shadow-primary/10 flex items-center gap-3"
                  >
          ...
          <aside className="space-y-8">
            <div className="bg-surface-container-high p-8 rounded-xl border border-outline-variant/20 shadow-sm">
              <h3 className="text-xl font-black uppercase tracking-tight text-on-background mb-6">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    <p className="text-xs uppercase font-bold text-outline-variant tracking-widest ml-1">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-black text-on-primary tracking-tight">
                          +91 97174 59360
                        </span>
                      </div>
                      <Icon
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-black text-surface tracking-tight">
                          +91 (124) 4900-888
                        </span>
                      </div>
                      <Icon
                        name="arrow_forward"
                        className="text-surface/50 group-hover:translate-x-1 transition-transform"
                      />
                    </a>
                  </div>
                </div>
                <div className="mt-8 pt-6 border-t border-surface/10 text-center">
                  <p className="text-[10px] font-medium text-surface-dim uppercase tracking-widest">
                    Average NCR Mobilization:{" "}
                    <span className="text-primary-fixed-dim font-bold">60-90 Mins</span>
                  </p>
                </div>
              </div>
            </div>
