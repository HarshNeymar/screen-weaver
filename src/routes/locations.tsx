  ...
  head: () => ({
    meta: [
      { title: "Locations | Chawla Cranes — Structural Authority" },
      {
        name: "description",
        content:
          "Strategic operational hubs across Gurugram, Manesar and Noida with rapid deployment of cranes and recovery fleet.",
      },
    ],
  }),
...
const hubs = [
  ...
  },
  {
    ...
    phone: "+91 97174 59360",
    img: "/images/cranes/80-ton-mobile-crane.webp",
  },
  {
    name: "Noida",
    badge: "UP OPERATIONS",
    ...
    <div className="bg-surface text-on-background">
      ...
      <main className="pt-24 pb-20 overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-end">
              ...
              <div className="lg:w-1/3 mb-4">
                <p className="text-lg text-secondary leading-relaxed border-l-4 border-primary pl-6">
                  Deploying the largest heavy-lift fleet across the North India corridor. From
                  Gurugram's high-rises to Manesar's industrial backbone.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-8 bg-surface-container-low rounded-xl overflow-hidden relative min-h-[600px] group shadow-inner">
                ...
                <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center cursor-pointer">
                  ...
                  <div className="mt-2 bg-white px-3 py-1 rounded shadow-lg text-xs font-bold uppercase tracking-tighter">
                    Gurugram HQ
                  </div>
                </div>
                ...
                <div className="relative z-20 p-12 h-full flex flex-col justify-end">
                  <h3 className="text-4xl font-bold text-on-background max-w-sm mb-4">
                    Unrivaled reach in the Haryana heartland.
                  </h3>
                  <div className="flex gap-4 flex-wrap">
                    <span className="bg-surface-container-lowest/80 backdrop-blur px-4 py-2 rounded text-xs font-bold border border-outline-variant/20 uppercase tracking-widest">
                      3 Strategic Yards
                    </span>
                    <span className="bg-surface-container-lowest/80 backdrop-blur px-4 py-2 rounded text-xs font-bold border border-outline-variant/20 uppercase tracking-widest">
                      150+ Fleet Units
              ...
              <div className="lg:col-span-4 flex flex-col gap-6">
                <div className="p-8 bg-primary-container text-on-primary-container rounded-xl flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm opacity-80 leading-relaxed">
                      Serving the robust manufacturing corridors of Manesar and Dharuhera with
                      specialized tower crane rigging for plant expansions.
                    </p>
                  </div>
                  <div className="pt-6 border-t border-on-primary-container/20 mt-6">
                    <span className="text-3xl font-black">40%</span>
                    <span className="text-xs uppercase tracking-widest block font-bold">
                      Sector Share
                    </span>
                  </div>
                </div>
                <div className="p-8 bg-surface-container-highest rounded-xl flex-1">
                  ...
                  <p className="text-sm text-secondary leading-relaxed">
                    Pioneering the skyline of Gurugram and Noida through ultra-heavy lifting for
                    high-rise commercial and residential projects.
                  </p>
        ...
        <section className="px-8 max-w-7xl mx-auto mb-32 overflow-hidden">
          <div className="flex items-end justify-between mb-12">
            ...
            <div className="hidden md:block text-secondary text-sm max-w-md text-right">
              Delivering crane, heavy lifting and infrastructure support services across premium
          ...
          <div className="mt-10 bg-primary-container rounded-2xl p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <h3 className="text-3xl font-black mb-2">Serving All Over NCR</h3>

              <p className="text-on-primary-container/80 max-w-2xl">
                Providing crane rental, infrastructure lifting, recovery support and industrial
                services across Gurugram, Delhi, Noida, Manesar and the entire NCR region.
              </p>
            </div>
        ...
        <section className="px-8 max-w-7xl mx-auto mb-32">
          <h2 className="text-4xl font-bold uppercase tracking-tight mb-12 border-l-8 border-primary pl-6">
            Operational Hubs
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {hubs.map((h) => (
              <div
                key={h.name}
                className="group bg-surface-container-low rounded-xl overflow-hidden hover:bg-surface-container-highest transition-colors duration-300"
              >
                ...
                <div className="p-8">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <span className={`${h.badgeClass} text-[10px] font-bold px-2 py-1 rounded`}>
                      {h.badge}
                    </span>
                  </div>
