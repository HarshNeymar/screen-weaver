...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium crane rentals and heavy recovery for IMT Manesar, Gurugram Industrial Hub and Delhi NCR." },
    ],
  }),
  component: HomePage,
});
        ...
        <section className="relative min-h-[900px] flex items-center pt-20">
          <div className="absolute inset-0 z-0">
            <img
              ...
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBcROowuHGVNy27VLgZx-p1V5n7g0-mO6o4KjfGArIdoesDQQud4WCMAzcw7LtFFx-uWOhg41p_rHJXMOhqmQnSfs0w0qXe5qWXdBXiRbdnjRW9oEJOagGJviTmjJIgy0tp4z6kTrXfIj9CUt1VTLUJ-0TyW0IONjDpriAoIZ45lArk387CHlAtHfLj0l4RuWCg2dS192TVTs1VHKGLyu7QC2-ChJEIuRfggCjdFkaG30cgs6jyH7OfYR5JiyXuJgIscS8U5tFmifg"
            />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="text-stone-300 text-lg md:text-xl font-medium mb-8 max-w-xl leading-relaxed">
                ...
                Precision engineered for monumental infrastructure.
              </p>
              <div className="flex flex-wrap gap-4 items-center">
                <div className="flex -space-x-3">
                  <div className="w-10 h-10 rounded-full border-2 border-stone-900 bg-stone-700 flex items-center justify-center text-[10px] font-bold text-white">L&T</div>
                  <div className="w-10 h-10 rounded-full border-2 border-stone-900 bg-stone-800 flex items-center justify-center text-[10px] font-bold text-white">DLF</div>
                  <div className="w-10 h-10 rounded-full border-2 border-stone-900 bg-stone-900 flex items-center justify-center text-[10px] font-bold text-white">TATA</div>
                </div>
                <span className="text-stone-400 text-sm font-bold tracking-tight">Trusted by Industry Titans across NCR</span>
              </div>
            </div>

            <div className="lg:col-span-5">
              <div className="bg-white/10 backdrop-blur-2xl p-8 rounded-2xl border border-white/20 shadow-2xl">
                <h3 className="text-xl font-black text-white mb-6 uppercase tracking-tight">Initiate Lift Plan</h3>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
              <div className="max-w-2xl">
                <h2 className="text-sm font-black uppercase tracking-[0.3em] text-primary mb-4">Core Competencies</h2>
                <p className="text-4xl md:text-5xl font-black tracking-tighter text-on-surface">Specialized Solutions for NCR Projects</p>
              </div>
              <Link to="/services" className="bg-primary text-on-primary px-6 py-3 rounded font-bold uppercase text-xs tracking-widest hover:brightness-110 transition-all shadow-md self-start md:self-end">
                Explore Full Fleet
              </Link>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.map((s) => (
                <div key={s.title} className="group bg-white rounded-2xl border border-outline-variant/50 p-6 hover:shadow-2xl hover:border-primary transition-all duration-300">
                  <div className="w-14 h-14 bg-surface-container-low rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary transition-colors">
                    <Icon name={s.icon} className="text-3xl text-primary group-hover:text-white transition-colors" />
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                <div className="inline-flex items-center gap-4 px-4 py-2 border border-primary/40 rounded bg-stone-900/40 mb-10">
                  ...
                  <span className="font-black tracking-[0.2em] uppercase text-[10px]">Headquartered in IMT Manesar</span>
                </div>
                <h2 className="text-5xl md:text-6xl font-black tracking-tighter mb-8 leading-tight">
                  THE AUTHORITY FOR <br /><span className="text-primary-container">NCR OPERATIONS.</span>
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12">
                  <div className="space-y-3 p-6 bg-stone-900/60 rounded-xl border-l-4 border-primary">
                    ...
                    <p className="text-stone-400 text-xs font-medium">Largest fleet deployment for automotive and pharmaceutical plants in the industrial hub.</p>
                  </div>
                  <div className="space-y-3 p-6 bg-stone-900/60 rounded-xl border-l-4 border-primary">
                    <h5 className="text-lg font-black text-primary-fixed-dim">Cyber City Sector</h5>
                    <p className="text-stone-400 text-xs font-medium">Precision high-rise structural support and equipment lifting for corporate developments.</p>
                  </div>
                </div>
              </div>
              <div className="bg-stone-950/40 backdrop-blur-xl p-8 rounded-3xl border border-white/10">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={l} className="p-6 bg-stone-900/80 rounded-2xl border border-white/5 text-center">
                      <p className="text-4xl font-black text-primary-container mb-1">{n}</p>
                      <p className="text-[9px] uppercase tracking-widest font-black text-stone-500">{l}</p>
                    </div>
                  ))}
                </div>
