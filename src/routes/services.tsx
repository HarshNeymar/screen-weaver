  ...
  head: () => ({
    meta: [
      { title: "Fleet & Services | Chawla Cranes — Heavy Lift Solutions" },
      {
        name: "description",
        content:
          "Hydra, Farana, tower and crawler cranes plus heavy recovery, towing and earthmoving across Gurugram, Noida and Manesar.",
      },
    ],
  }),
...
const sections: Section[] = [
  {
    ...
    img: "/images/cranes/25-ton-mobile-crane.webp",
    badge: "Mobile Units",
    rows: [
  ...
  },
  {
    ...
    img: "/images/cranes/60-ton-crawler-crane.webp",
                ...
                <section key={s.id} id={s.id} className="scroll-mt-28">
                  ...
                  <div className="overflow-hidden rounded-xl border border-outline-variant/30">
                    <div className="bg-surface-container-high p-4 border-b border-outline-variant/30 flex justify-between items-center">
                      <h3 className="font-black uppercase text-sm tracking-widest text-secondary">
                        Technical Spec Sheet
                      </h3>
                      <span className="text-[10px] bg-primary-container px-2 py-0.5 rounded font-bold uppercase">
                        {s.badge}
                      </span>
                    </div>
                      ...
                      <tbody className="divide-y divide-outline-variant/10">
                        {s.rows.map((r, i) => (
                          <tr key={i} className="hover:bg-surface-container-low transition-colors">
                            ...
                            <td className="p-4 text-right" colSpan={r[2] ? 1 : 2}>
                              {r[1]}
                            </td>
                ...
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-secondary leading-relaxed">
                      Specialized recovery for stranded heavy machinery and oversized commercial
                      vehicles across North Indian highways. 24/7 emergency response.
                    </p>
                    <a
                      className="text-primary font-black uppercase text-xs tracking-widest inline-flex items-center gap-1 hover:underline"
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-secondary leading-relaxed">
                      Integrated site preparation solutions. Our earthmoving fleet complements our
                      lifting services for seamless site mobilization.
                    </p>
                    <a
                      className="text-primary font-black uppercase text-xs tracking-widest inline-flex items-center gap-1 hover:underline"
                      href="/contact"
            ...
            <aside className="lg:col-span-4">
              <div className="sticky top-28 space-y-8">
                <div className="bg-on-background text-white p-8 rounded-xl shadow-2xl overflow-hidden relative">
                  ...
                  <p className="text-stone-400 text-xs mb-8 relative z-10">
                    Immediate 24-hour dispatch for NCR operations.
                  </p>
                  <div className="space-y-4 mb-8">
                    {["Gurugram Central", "Noida Ind. Area", "Manesar Hub"].map((l) => (
                      <div
                        key={l}
                        className="flex items-center gap-3 bg-white/5 p-3 rounded border border-white/10 hover:border-primary-container transition-colors cursor-pointer"
                      >
                ...
                <div className="bg-white border border-outline-variant/30 p-8 rounded-xl space-y-6">
                  <h4 className="font-black uppercase tracking-widest text-[10px] text-secondary">
                    ...
                    {[
                      {
                        ...
                        b: "All pilots undergo rigorous biannual safety recertification and medical checks.",
                      },
                      {
                        c: "bg-amber-100 text-amber-700",
                        icon: "settings_suggest",
                        t: "Rigorous Maintenance",
                        b: "Daily pre-shift inspections and monthly load testing following OEM standards.",
                      },
                      {
                        c: "bg-blue-100 text-blue-700",
                        icon: "shield",
                        t: "Third-Party Insured",
                        b: "Comprehensive transit and operational liability coverage for all site activities.",
                      },
                    ].map((x) => (
